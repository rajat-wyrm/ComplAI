...
class AIService:
    ...
    def get_system_prompt(self) -> str:
        return """You are an AI Compliance Risk Auditor. Analyze the given document and generate a structured compliance report. Return ONLY valid JSON. The JSON must have the following keys: company_name, document_type, risk_score (0-100), compliance_score (0-100), confidence_score (0-100), issues (array of objects with title, severity, category, description, recommendation), summary, recommendations (array of strings), missing_elements (array of strings)."""
...
"""
        prompt += """Generate compliance analysis in JSON format with:
- company_name: string
- document_type: string (Resume, Policy, Legal, Contract, Report, Notes, etc.)
- risk_score: integer 0-100
- compliance_score: integer 0-100
- confidence_score: integer 0-100
- issues: list of objects each with title, severity (Low/Medium/High), category, description, recommendation
- summary: string
- recommendations: list of strings
- missing_elements: list of strings (compliance gaps)
"""
        return prompt
