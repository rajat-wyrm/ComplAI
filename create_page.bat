...
mkdir "C:\Users\rajat\ai-compliance-copilot\frontend\app\analysis" 2>nul
mkdir "C:\Users\rajat\ai-compliance-copilot\frontend\app\analysis\[id]" 2>nul
echo "use client";
...
' > "C:\Users\rajat\ai-compliance-copilot\frontend\app\analysis\[id]\page.tsx"
echo Analysis page created successfully!
